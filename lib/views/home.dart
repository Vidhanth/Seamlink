...
class Home extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Obx(() {
      if (Get.find<UserController>().username.isEmpty) return NoUserScreen();
      return Scaffold(
                            ...
                            children: [
                              if (isMobile) ...[
                                InkWell(
                                  ...
                                  child: Padding(
                                    padding:
                                        EdgeInsets.only(right: 20.0, left: 0),
                                    child: Icon(
                                      LineIcons.bars,
                                      size: 40,
                                    ),
                              ...
                              child: homeController.isLoading.value
                                  ...
                                  : RefreshIndicator(
                                      ...
                                      child: AllLinksView(
                                        ...
                                        allLinks:
                                            homeController.linksList.value,
                                        searchText:
